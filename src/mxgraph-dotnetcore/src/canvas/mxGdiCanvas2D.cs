...
namespace com.mxgraph
{
    ...
    public class mxGdiCanvas2D : mxICanvas2D
    {
        ...
        /// Draws an image.
        /// </summary>
        public async void Image(double x, double y, double w, double h, String src,
                bool aspect, bool flipH, bool flipV)
        {
            if (src != null && w > 0 && h > 0)
            {
                Image image = await LoadImage(src);
        ...
        /// </summary>
        protected async System.Threading.Tasks.Task<Image> LoadImage(String src)
        {
            return await mxUtils.LoadImage(src);
        }
